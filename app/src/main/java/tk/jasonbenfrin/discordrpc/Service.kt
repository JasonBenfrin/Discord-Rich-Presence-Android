    ...
    inner class DiscordWebSocketListener : WebSocketListener() {
        ...
        override fun onMessage(webSocket: WebSocket, text: String) {
            ...
            when (json.get("op").asInt) {
                0 -> {
                    log("WebSocket: Event ${json.get("t")} Received")
                    if(json.has("s")) {
        ...
        override fun onFailure(webSocket: WebSocket, t: Throwable, response: Response?) {
            ...
            errorNotification("Received Error", "Please reset the presence")
        ...
        override fun onClosed(webSocket: WebSocket, code: Int, reason: String) {
            ...
            if(code >= 4000) {
                ...
                errorNotification("Received Error $code", "Please reset the presence")
                return
            }
        }
